...
function Install-ADTDeployment {
    ...
    Start-ADTProcess -FilePath "MathType-win-en-7.8.0.0.exe" -ArgumentList "/S /p $($secrets.product_key) /n `"Fagskole Møre og Romsdal`" /a"
...
function Uninstall-ADTDeployment {
    ...
    ##================================================
    $adtSession.InstallPhase = $adtSession.DeploymentType
    Start-ADTProcess -FilePath "C:\Program Files (x86)\MathType\Setup.exe" -ArgumentList "-Q -R"
